...
import {AlexaSmartHomeCauseType, AlexaSmartHomeChangeReportResponse} from "@libs/alexaSmartHome";
...
export async function alexaNotifyAddOrUpdate(uid: string, endpointId: string, changeProperties:any[], contextProperties:any[]) : Promise<ChnageReportResponse> {
...
export async function alexaNotifyChangeReport(uid: string, endpointId: string, changeProperties:any[], contextProperties:any[]) : Promise<ChnageReportResponse> {
    let forceRefreshToken = false;
    let retryCount = 3;
    ...
    while (true) {
        ...
        let changeReportEvent : AlexaSmartHomeChangeReportResponse = {
            "context": {
                "properties": contextProperties
            },
            "event": {
